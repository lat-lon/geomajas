...
public class NumberOfFeaturesInEnvelopeFromWfsRetrieverIT {
	...
	private static final String WFS_URL = "http://178.63.99.239:8080/xplansyn-wfs/services?request=GetFeature&version=1.1.0&typename=xplansyn:${DATASOURCENAME}&resulttype=hits&service=WFS";
	...
	public void testIsAtLeastOneFeatureInEnvelopeWith0Features() throws Exception {
		boolean isAtLeastOneFeatureInEnvelope = numberOfFeaturesInEnvelopeRetriever.isAtLeastOneFeatureInEnvelope(
				rasterLayerInfo, BBOX_WITH_0_FEATURES);
	...
	public void testIsAtLeastOneFeatureInEnvelopeWith175Features() throws Exception {
		boolean isAtLeastOneFeatureInEnvelope = numberOfFeaturesInEnvelopeRetriever.isAtLeastOneFeatureInEnvelope(
				rasterLayerInfo, BBOX_WITH_175_FEATURES);
	...
	public void testIsAtLeastOneFeatureInEnvelopeWith253Features() throws Exception {
		boolean isAtLeastOneFeatureInEnvelope = numberOfFeaturesInEnvelopeRetriever.isAtLeastOneFeatureInEnvelope(
				rasterLayerInfo, BBOX_WITH_253_FEATURES);
		assertThat(isAtLeastOneFeatureInEnvelope, is(true));
	}

	@Test
	public void testCountFeaturesInEnvelopeWith0Features() throws Exception {
		int numberOfFeatures = numberOfFeaturesInEnvelopeRetriever.countFeaturesInEnvelope(rasterLayerInfo,
				BBOX_WITH_0_FEATURES);
