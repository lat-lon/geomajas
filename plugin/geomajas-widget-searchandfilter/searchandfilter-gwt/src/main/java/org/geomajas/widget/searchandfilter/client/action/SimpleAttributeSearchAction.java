...
import org.geomajas.widget.searchandfilter.client.widget.attributesearch.SimpleAttributeSearchCreator;
 ...
 * 
 */
public class SimpleAttributeSearchAction extends ToolbarAction implements ConfigurableAction {

    private static final SearchAndFilterMessages MESSAGES = GWT.create( SearchAndFilterMessages.class );

    public static final String IDENTIFIER = SimpleAttributeSearchCreator.IDENTIFIER;

    public SimpleAttributeSearchAction() {
    ...
    public void onClick( ClickEvent event ) {
        SearchWidgetRegistry.getSearchWidgetInstance( IDENTIFIER ).showForSearch();
    }
